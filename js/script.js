...
jQuery(document).ready(function($) {
	$('.menu__icon').click(function(event) {
		$('.menu__icon,.header__list, .header__link, body, .header__link-link').toggleClass('_active');
	});
	$('.header__link').click(function(event) {
		$('.menu__icon,.header__list, .header__link, body').removeClass('_active');
	});
});;
const swiperTim = new Swiper('.tim', {
    // Optional parameters
    loop: true,
...
const swiperOlivia = new Swiper('.olivia', {
    // Optional parameters
    loop: true,
...
let kittensLi = document.querySelector('.header__list-list');
let kittensUl = document.querySelector('.header__list-kittens');

kittensLi.addEventListener('click', function() {
	kittensUl.classList.toggle("active");
})